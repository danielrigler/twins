...
--
-- E1: Master Volume
-- E2: Seek1 or Varispeed |>
-- E3: Seek2 or Varispeed |>
-- K1: Shift
-- K2: Randomize1
-- K3: Randomize2
-- K2/K3 x2: Stop Randomization
-- k1+K2: Play1 / Stop
-- K1+K3: Play2 / Stop
-- K1+E1: Seek1 >< Seek2
-- K1+E2: Volume1
...
local speed_scale = 0.18  -- for automate seek
...
local function randomize(n)
    ...
    randomize_metro[n].time = 1/30
        ...
        for param, target in pairs(targets) do
            local current_value = params:get(n .. param)
            ...
            params:set(n .. param, new_value)
        end

        -- If all parameters have reached their target values, stop the metro
