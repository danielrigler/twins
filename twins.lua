...
local function setup_params()
    ...
    params:add_control("glitch_mix", "Mix", controlspec.new(0, 100, "lin", 1, 0, "%")) params:set_action("glitch_mix", function(value) engine.glitch_mix(value * 0.01) font.update_fx_cache("glitch_mix", value) end)
    params:add_control("glitch_ratio", "Glitch Ratio", controlspec.new(0, 100, "lin", 1, 50, "%")) params:set_action("glitch_ratio", function(value) engine.glitch_ratio(value * 0.01) end)
    ...
    params:add_control("glitch_min_length", "Min Length", controlspec.new(10, 100, "lin", 1, 10, "ms")) params:set_action("glitch_min_length", function(value) engine.glitch_min_length(value * 0.001) end)
    ...
    params:add_control("glitch_reverse", "Reverse Prob", controlspec.new(0, 100, "lin", 1, 30, "%")) params:set_action("glitch_reverse", function(value) engine.glitch_reverse(value * 0.01) end)
    params:add_control("glitch_pitch", "Pitch Prob", controlspec.new(0, 100, "lin", 1, 20, "%")) params:set_action("glitch_pitch", function(value) engine.glitch_pitch(value * 0.01) end)
    params:add_separator("       ")
    params:add_binary("randomize_glitch", "RaNd0m1ze!", "trigger", 0) params:set_action("randomize_glitch", function() 
        if params:get("lock_glitch") == 1 then
            ...
            params:set("glitch_ratio", math.random(0, 100))
            params:set("glitch_min_length", math.random(10, 100))
            params:set("glitch_max_length", math.random(100, 500))
            params:set("glitch_reverse", math.random(0, 100))
            params:set("glitch_pitch", math.random(0, 100))
        end
    end)
   ...
   ["/twins/buffer_loaded"] = function(args)
    ...
    ["/twins/output_saved"] = function(args)
        ...
        tracked_clock_run(function()
            clock.sleep(0.1)
            params:set("1granular_gain", 0) disable_lfos_for_param("1speed") disable_lfos_for_param("1pan") params:set("1speed", 1) params:set("1sample", filepath) params:set("1pan", 0) params:set("2pan", 0) params:set("reverb_mix", 0) params:set("delay_mix", 0) params:set("shimmer_mix1", 0) params:set("glitch_mix", 0) params:set("tape_mix", 1) params:set("dimension_mix", 0) params:set("sine_drive_wet", 0) params:set("drive", 0) params:set("wobble_mix", 0) params:set("chew_depth", 0) params:set("lossdegrade_mix", 0) params:set("Width", 100)  params:set("rspeed", 0) params:set("haas", 1) params:set("monobass_mix", 1) params:set("bitcrush_mix", 0) params:set("1lock_speed", 2)
