...
local function setup_params()
    ...
    params:add_taper("delay_duck", "Ducking", 0, 100, 15, 0, "%") params:set_action("delay_duck", function(value) engine.delay_duck(value * 0.01) end)
    params:add_separator("   ")
    ...
    params:add_taper("rev_prefilter", "Pre Filter", 0, 100, 25, 0, "%") params:set_action("rev_prefilter", function(value) engine.rev_prefilter(value * 0.01) end)
    ...
    params:add_taper("rev_modrate", "Mod Rate", 0.1, 3.6, 2, 0, "Hz") params:set_action("rev_modrate", function(value) engine.rev_modrate(value) end)
    params:add_taper("rev_lowmult", "Bass Decay", 0, 300, 100, 0, "%") params:set_action("rev_lowmult", function(value) engine.rev_lowmult(value * 0.01) end)
    params:add_separator("  ")
