...
local function setup_params()
    ...
    params:add_control("evolution_range", "Evolution Range", controlspec.new(0, 100, "lin", 1, 35, "%")) params:set_action("evolution_range", function(value) randpara.set_evolution_range(value) end)
