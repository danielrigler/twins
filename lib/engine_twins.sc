...
alloc {
        ...
        o = OSCFunc({ |msg| nornsAddr.sendMsg("/twins/voice_state", msg[3].asInteger, msg[4], msg[5], msg[6]); }, '/voice_state', context.server.addr);
