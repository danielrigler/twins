...
local function randomize_params()
    ...
    --GREYHOLE      
    params:set("greyhole_mix", random_float(0, 0.5))
    ...
    params:set("reverb_predelay", math.random(10, 250))
    ...
    --OTHERS
    params:set("density_mod_amt", math.random(0, 40))
    if math.random() <= 0.25 then params:set("subharmonics_1", 0) else params:set("subharmonics_1", random_float(0, 0.5)) end
    if math.random() <= 0.25 then params:set("subharmonics_2", 0) else params:set("subharmonics_2", random_float(0, 0.5)) end   
    if math.random() <= 0.25 then params:set("overtones_1", 0) else params:set("overtones_1", random_float(0, 0.5)) end
    if math.random() <= 0.25 then params:set("overtones_2", 0) else params:set("overtones_2", random_float(0, 0.5)) end    
end
