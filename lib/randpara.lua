...
local function randomize_params()
    ...
    params:set("delay_rate", random_float(0.3, 2))
    params:set("delay_feedback", math.random(40, 90))
    ...
    --FVERB
    params:set("reverb_mix", math.random(5, 30))
    params:set("reverb_predelay", math.random(0, 85))
    params:set("reverb_lowpass_cutoff", math.random(7000, 12000))
    params:set("reverb_highpass_cutoff", math.random(100, 300))
    params:set("reverb_diffusion_1", math.random(60, 90))
    params:set("reverb_tail_density", math.random(50, 85))
    params:set("reverb_decay", math.random(60, 95))
    params:set("reverb_damping", math.random(5500, 7500))
    params:set("reverb_modulator_frequency", random_float(0.2, 1.2))
    params:set("reverb_modulator_depth", math.random(60, 100))
    
    --OTHERS
    params:set("density_mod_amt", math.random(0, 40))
    params:set("subharmonics_1", random_float(0, 0.25))
    params:set("subharmonics_2", random_float(0, 0.25))
    params:set("overtones_1", random_float(0, 0.25))
    params:set("overtones_2", random_float(0, 0.25))
