...
local param_configs = {
  dverb = { lock_param = "lock_reverb", params = {
    ...
    {name="rev_prefilter",  prob=0.4,  default=40,   random=function() return random_float(15,90)         end},
    {name="rev_hpf",        prob=0.5,  default=20,   random=function() return random_float(20,300)       end},
    {name="rev_moddepth",   prob=0.5,  default=50,   random=function() return math.random(0,100)         end},
    {name="rev_modrate",    prob=0.5,  default=2.5,  random=function() return random_float(0.2,4)        end},
  }},
  shimmer = { lock_param = "lock_shimmer", params = {
    ...
    {name="fb1",          prob=0.3,  default=20,     random=function() return math.random(10,35)       end},
  ...
  delay = { lock_param = "lock_delay", params = {
    ...
    {name="wiggle_depth",   prob=0.3, default=20,    random=function() return math.random(0,100)         end, direct_set=true},
    {name="wiggle_rate",    prob=0.75, default=2,     random=function() return random_float(0.4,4)        end},
  }},
  tape = { lock_param = "lock_tape", params = {
    {name="wobble_amp",  prob=0.75, default=10, random=function() return math.random(1,15)  end},
    {name="wobble_rpm",  prob=0.75, default=33, random=function() return math.random(30,70) end},
    {name="flutter_amp", prob=0.75, default=15, random=function() return math.random(1,30)  end},
    {name="flutter_freq",prob=0.75, default=6,  random=function() return math.random(2,10)  end},
  ...
  sync = { lock_param = "lock_sync", params = {
    {name="clock_sync_delay_div", prob=0.75, default=13, random=function() return math.random(9,18) end, direct_set=true, condition=function() return params:get("clock_sync") == 2 end},
  }},
}
